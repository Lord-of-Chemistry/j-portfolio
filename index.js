...
ScrollReveal().reveal(".project-box", { delay: 500, origin: 'bottom'})
ScrollReveal().reveal(".project-h2", { delay: 500, origin: 'top'})
ScrollReveal().reveal(".card", { delay: 500, origin: 'left'})
ScrollReveal().reveal(".input-box", { delay: 500, origin: 'top'})
ScrollReveal().reveal(".input-group-2", { delay: 500, origin: 'bottom'})
